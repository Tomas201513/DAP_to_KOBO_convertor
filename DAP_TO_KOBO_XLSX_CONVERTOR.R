...
data <- read_excel("C:/Users/test/Downloads/REACH_HSM_Round2_DAP_26Dec2024.xlsx", sheet = "Data Analysis Plan - Dec 2024")

#rename specific column names
data <- data %>% rename(`# Question` = `Questionnaire Question`,
                        `Answer Options` = `Questionnaire Responses`)
